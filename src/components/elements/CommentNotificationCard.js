...
export const CommentNotificationCard = ({notification, setDropNotifications="", setDeletedId}) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col ml-2">
        ...
        <span>just commented on your post!<i className="ml-1 bi bi-chat"></i></span>
      </div>
      <div className="absolute top-0 bottom-0 right-1 flex items-center">
        <span 
        className="rounded-full p-2 hover:bg-gray-200 hover:dark:bg-gray-600"
